...
Post.create(learning_item: 1,learning_hour: 2 ,learning_content:"経済",user_id:1,created_at: DateTime.now - 3)
Post.create(learning_item: 1,learning_hour: 2 ,learning_content:"経済",user_id:1,created_at: DateTime.now - 2)
Post.create(learning_item: 1,learning_hour: 2 ,learning_content:"経済",user_id:1,created_at: DateTime.now - 4)
Post.create(learning_item: 1,learning_hour: 2 ,learning_content:"経済",user_id:1,created_at: DateTime.now - 5)
Post.create(learning_item: 1,learning_hour: 2 ,learning_content:"経済",user_id:1,created_at: DateTime.now - 6)
